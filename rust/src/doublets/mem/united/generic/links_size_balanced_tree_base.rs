...
pub trait LinksSizeBalancedTreeBaseAbstract<T: LinkType>: SizeBalancedTreeMethods<T> + ILinksTreeMethods<T> {
...
//impl<T: LinkType> LinksSizeBalancedTreeBaseAbstract<T> for LinksSizeBalancedTreeBase<T> {
//
//}
