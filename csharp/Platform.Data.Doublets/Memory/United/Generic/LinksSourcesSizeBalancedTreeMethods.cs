...
namespace Platform.Data.Doublets.Memory.United.Generic
{
    /// <summary>
    /// <para>
    /// Represents the links sources size balanced tree methods.
    /// </para>
    /// <para></para>
    /// </summary>
    /// <seealso cref="LinksSizeBalancedTreeMethodsBase{TLinkAddress}"/>
    public unsafe class LinksSourcesSizeBalancedTreeMethods<TLinkAddress> : LinksSizeBalancedTreeMethodsBase<TLinkAddress> where TLinkAddress : IUnsignedNumber<TLinkAddress>, IComparisonOperators<TLinkAddress, TLinkAddress, bool>
    {
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="LinksSourcesSizeBalancedTreeMethods"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
        ...
        public LinksSourcesSizeBalancedTreeMethods(LinksConstants<TLinkAddress> constants, byte* links, byte* header) : base(constants, links, header) { }
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected override bool FirstIsToTheLeftOfSecond(TLinkAddress firstSource, TLinkAddress firstTarget, TLinkAddress secondSource, TLinkAddress secondTarget) => firstSource < secondSource || (AreEqual(firstSource, secondSource) && firstTarget < secondTarget);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected override bool FirstIsToTheRightOfSecond(TLinkAddress firstSource, TLinkAddress firstTarget, TLinkAddress secondSource, TLinkAddress secondTarget) => firstSource > secondSource || (AreEqual(firstSource, secondSource) && firstTarget > secondTarget);
