...
namespace Platform.Data.Doublets.Memory.United.Specific
{
    /// <summary>
    /// <para>
    /// Represents the int 32 links sources size balanced tree methods.
    /// </para>
    /// <para></para>
    /// </summary>
    /// <seealso cref="UInt32LinksSizeBalancedTreeMethodsBase"/>
    public unsafe class UInt32LinksSourcesSizeBalancedTreeMethods : UInt32LinksSizeBalancedTreeMethodsBase
    {
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="UInt32LinksSourcesSizeBalancedTreeMethods"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
        ...
        /// <para></para>
        /// </param>
        public UInt32LinksSourcesSizeBalancedTreeMethods(LinksConstants<uint> constants, RawLink<uint>* links, LinksHeader<uint>* header) : base(constants, links, header) { }
