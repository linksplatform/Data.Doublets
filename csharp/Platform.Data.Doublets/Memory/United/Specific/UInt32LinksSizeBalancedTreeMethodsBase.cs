...
namespace Platform.Data.Doublets.Memory.United.Specific
{
    /// <summary>
    /// <para>
    /// Represents the int 32 links size balanced tree methods base.
    /// </para>
    /// <para></para>
    /// </summary>
    /// <seealso cref="LinksSizeBalancedTreeMethodsBase{uint}"/>
    public unsafe abstract class UInt32LinksSizeBalancedTreeMethodsBase : LinksSizeBalancedTreeMethodsBase<uint>
    {
        /// <summary>
        /// <para>
        /// The links.
        ...
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="UInt32LinksSizeBalancedTreeMethodsBase"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
        ...
        /// <para></para>
        /// </param>
        protected UInt32LinksSizeBalancedTreeMethodsBase(LinksConstants<uint> constants, RawLink<uint>* links, LinksHeader<uint>* header)
