...
/// <summary>
///     <para>
///         Represents the external links sources recursionless size balanced tree methods.
///     </para>
///     <para></para>
/// </summary>
/// <seealso cref="ExternalLinksRecursionlessSizeBalancedTreeMethodsBase{TLinkAddress}" />
public unsafe class ExternalLinksSourcesRecursionlessSizeBalancedTreeMethods<TLinkAddress> : ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLinkAddress> where TLinkAddress : IUnsignedNumber<TLinkAddress>
{
    /// <summary>
    ///     <para>
    ///         Initializes a new <see cref="ExternalLinksSourcesRecursionlessSizeBalancedTreeMethods" /> instance.
    ///     </para>
    ///     <para></para>
    /// </summary>
    ...
    public ExternalLinksSourcesRecursionlessSizeBalancedTreeMethods(LinksConstants<TLinkAddress> constants, byte* linksDataParts, byte* linksIndexParts, byte* header) : base(constants: constants, linksDataParts: linksDataParts, linksIndexParts: linksIndexParts, header: header) { }
    ...
    {
        return LessThan(first: firstSource, second: secondSource) || (AreEqual(first: firstSource, second: secondSource) && LessThan(first: firstTarget, second: secondTarget));
    }
    ...
    {
        return GreaterThan(first: firstSource, second: secondSource) || (AreEqual(first: firstSource, second: secondSource) && GreaterThan(first: firstTarget, second: secondTarget));
    }
