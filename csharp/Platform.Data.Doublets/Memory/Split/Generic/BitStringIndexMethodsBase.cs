...
namespace Platform.Data.Doublets.Memory.Split.Generic
{
    /// <summary>
    ///     <para>
    ///         Represents the bitstring index methods base.
    ///     </para>
    ///     <para></para>
    /// </summary>
    /// <seealso cref="IBitStringTreeMethods{TLinkAddress}" />
    public abstract unsafe class BitStringIndexMethodsBase<TLinkAddress> : IBitStringTreeMethods<TLinkAddress> 
        where TLinkAddress : IUnsignedNumber<TLinkAddress>, IComparisonOperators<TLinkAddress, TLinkAddress, bool>
    {
        ...
        /// <summary>
        ///     <para>
        ///         Initializes a new <see cref="BitStringIndexMethodsBase" /> instance.
        ///     </para>
        ///     <para></para>
        /// </summary>
        ...
        protected BitStringIndexMethodsBase(LinksConstants<TLinkAddress> constants, byte* linksDataParts, byte* linksIndexParts, byte* header, int defaultBitStringSize = 1024)
        {
