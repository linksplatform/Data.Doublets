...
public unsafe class ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods<TLinkAddress> : ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLinkAddress> where TLinkAddress : IUnsignedNumber<TLinkAddress>
{
    /// <summary>
    ///     <para>
    ...
    public ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods(LinksConstants<TLinkAddress> constants, byte* linksDataParts, byte* linksIndexParts, byte* header) : base(constants: constants, linksDataParts: linksDataParts, linksIndexParts: linksIndexParts, header: header) { }
    ...
    {
        return LessThan(first: firstTarget, second: secondTarget) || (AreEqual(first: firstTarget, second: secondTarget) && LessThan(first: firstSource, second: secondSource));
    }
    ...
    {
        return GreaterThan(first: firstTarget, second: secondTarget) || (AreEqual(first: firstTarget, second: secondTarget) && GreaterThan(first: firstSource, second: secondSource));
    }
