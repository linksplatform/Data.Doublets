...
namespace Platform.Data.Doublets.Memory.Split.Generic
{
    ...
    public unsafe class ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods<TLink> : ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink>
    {
        /// <summary>
        /// <para>
        ...
        public ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods(LinksConstants<TLink> constants, byte* linksDataParts, byte* linksIndexParts, byte* header) : base(constants, linksDataParts, linksIndexParts, header) { }
