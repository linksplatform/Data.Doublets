...
namespace Platform.Data.Doublets.Memory.Split.Generic
{
    ...
    public unsafe class InternalLinksSourcesRecursionlessSizeBalancedTreeMethods<TLink> : InternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink>
    {
        /// <summary>
        /// <para>
        ...
        public InternalLinksSourcesRecursionlessSizeBalancedTreeMethods(LinksConstants<TLink> constants, byte* linksDataParts, byte* linksIndexParts, byte* header) : base(constants, linksDataParts, linksIndexParts, header) { }
