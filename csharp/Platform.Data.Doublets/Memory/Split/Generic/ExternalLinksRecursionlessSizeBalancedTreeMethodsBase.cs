...
public abstract unsafe class ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLinkAddress> : RecursionlessSizeBalancedTreeMethods<TLinkAddress>, ILinksTreeMethods<TLinkAddress> where TLinkAddress : IUnsignedNumber<TLinkAddress>, IComparisonOperators<TLinkAddress, TLinkAddress, bool>
{
    ...
    /// <summary>
    ///     <para>
    ///         Initializes a new <see cref="ExternalLinksRecursionlessSizeBalancedTreeMethodsBase" /> instance.
    ///     </para>
    ///     <para></para>
    /// </summary>
    ...
    protected ExternalLinksRecursionlessSizeBalancedTreeMethodsBase(LinksConstants<TLinkAddress> constants, byte* linksDataParts, byte* linksIndexParts, byte* header)
    {
