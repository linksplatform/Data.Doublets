...
namespace Platform.Data.Doublets.Memory.Split.Generic
{
    ...
    /// <para></para>
    /// </summary>
    /// <seealso cref="RecursionlessSizeBalancedTreeMethods{TLink}"/>
    /// <seealso cref="ILinksTreeMethods{TLink}"/>
    public unsafe abstract class ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink> : RecursionlessSizeBalancedTreeMethods<TLink>, ILinksTreeMethods<TLink>
    {
        ...
        protected ExternalLinksRecursionlessSizeBalancedTreeMethodsBase(LinksConstants<TLink> constants, byte* linksDataParts, byte* linksIndexParts, byte* header)
        {
