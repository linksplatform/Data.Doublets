...
namespace Platform.Data.Doublets.Memory.Split.Generic
{
    ...
    public unsafe class InternalLinksTargetsSizeBalancedTreeMethods<TLinkAddress> : InternalLinksSizeBalancedTreeMethodsBase<TLinkAddress>
    {
        /// <summary>
        /// <para>
        ...
        public InternalLinksTargetsSizeBalancedTreeMethods(LinksConstants<TLinkAddress> constants, byte* linksDataParts, byte* linksIndexParts, byte* header) : base(constants, linksDataParts, linksIndexParts, header) { }
