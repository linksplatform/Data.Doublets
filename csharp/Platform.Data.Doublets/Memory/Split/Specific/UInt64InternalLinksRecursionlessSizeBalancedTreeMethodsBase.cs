...
namespace Platform.Data.Doublets.Memory.Split.Specific
{
    /// <summary>
    /// <para>
    /// Represents the int 64 internal links recursionless size balanced tree methods base.
    /// </para>
    /// <para></para>
    /// </summary>
    ...
    public unsafe abstract class UInt64InternalLinksRecursionlessSizeBalancedTreeMethodsBase : InternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink>
    {
        ...
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="UInt64InternalLinksRecursionlessSizeBalancedTreeMethodsBase"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
