...
namespace Platform.Data.Doublets.Memory.Split.Specific
{
    ...
    public unsafe class UInt64ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods : UInt64ExternalLinksRecursionlessSizeBalancedTreeMethodsBase
    {
        ...
        public UInt64ExternalLinksTargetsRecursionlessSizeBalancedTreeMethods(LinksConstants<TLink> constants, RawLinkDataPart<TLink>* linksDataParts, RawLinkIndexPart<TLink>* linksIndexParts, LinksHeader<TLink>* header) : base(constants, linksDataParts, linksIndexParts, header) { }
