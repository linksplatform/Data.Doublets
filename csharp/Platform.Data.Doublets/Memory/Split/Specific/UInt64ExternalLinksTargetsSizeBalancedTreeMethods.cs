...
namespace Platform.Data.Doublets.Memory.Split.Specific
{
    /// <summary>
    /// <para>
    /// Represents the int 64 external links targets size balanced tree methods.
    /// </para>
    /// <para></para>
    /// </summary>
    ...
    public unsafe class UInt64ExternalLinksTargetsSizeBalancedTreeMethods : UInt64ExternalLinksSizeBalancedTreeMethodsBase
    {
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="UInt64ExternalLinksTargetsSizeBalancedTreeMethods"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
