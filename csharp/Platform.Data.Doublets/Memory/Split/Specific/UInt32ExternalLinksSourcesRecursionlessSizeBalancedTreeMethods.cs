...
namespace Platform.Data.Doublets.Memory.Split.Specific
{
    /// <summary>
    /// <para>
    /// Represents the int 32 external links sources recursionless size balanced tree methods.
    /// </para>
    /// <para></para>
    /// </summary>
    ...
    public unsafe class UInt32ExternalLinksSourcesRecursionlessSizeBalancedTreeMethods : UInt32ExternalLinksRecursionlessSizeBalancedTreeMethodsBase
    {
        /// <summary>
        /// <para>
        /// Initializes a new <see cref="UInt32ExternalLinksSourcesRecursionlessSizeBalancedTreeMethods"/> instance.
        /// </para>
        /// <para></para>
        /// </summary>
