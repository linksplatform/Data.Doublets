namespace Platform::Data::Doublets::Tests
{
    ...
    public:
        ...
        static typename TStorage::LinkAddressType TestCreate(TStorage& storage)
        {
            ...
            storage.Each( Link{constants.Any, constants.Any, constants.Any} , [&linkStruct, _continue](const typename TStorage::LinkType& link) {
        ...
        static typename TStorage::LinkAddressType GetFirstLink(TStorage& storage, typename TStorage::LinkAddressType linkAddress)
        {
            ...
            storage.Each(Link{constants.Any, constants.Any, constants.Any}, [_continue, &linkAddressFromEach](const typename TStorage::LinkType& link) {
        ...
        static void TestDelete(TStorage& storage, typename TStorage::LinkAddressType linkAddress)
        {
            ...
            storage.Each(Link{constants.Any, constants.Any, constants.Any}, [_continue, &deletedLinkAddress](const typename TStorage::LinkType& link) {
    ...
    static void TestRawNumbersCrudOperations(TStorage& storage)
    {
        ...
        storage.Each(Link{any, h106E.Value, h108E.Value}, [&searchedLinkAddress, _continue](const typename TStorage::LinkType& link) {
...
//        storage.Each(Link{any, h106E.Value, h108E.Value}, [&searchedNonExistentypename TStorage::LinkAddressType, _continue](const typename TStorage::LinkType& link) {
...
//        Expects(constants.Null == searchedNonExistentypename TStorage::LinkAddressType);
        ...
        typename TStorage::LinkAddressType deletedLinkAddress {};
        storage.Each(Link{any, any, any}, [&deletedLinkAddress, _continue](const typename TStorage::LinkType& link) {
            deletedLinkAddress = link[0];
            return _continue;
        });
