namespace Platform::Data::Doublets::Tests
{
    ...
    static void TestNonexistentReferences(auto&& &memoryAdapter)
    {
        ...
        memoryAdapter.Each(std::array{_constants.Any, std::numeric_limits<std::uint64_t>::max(), std::numeric_limits<std::uint64_t>::max()}, [&resultLink] (Interfaces::CArray<TLinkAddress> auto foundLink) {
