namespace Platform::Data::Doublets::Memory::United::Generic
{
    ...
    class UnitedMemoryLinks : Interfaces::Polymorph<UnitedMemoryLinks<TLinkAddress, TMemory, TSourceTreeMethods, TTargetTreeMethods, TUnusedLinks>>/*: public std::enable_shared_from_this<UnitedMemoryLinks<TLinkAddress>>*/
    {
    public:
    ...
    private:
        ...
        // private: using _memory;

        // TODO: implicit constructor for Constants
    public:
        UnitedMemoryLinks(TMemory memory) :
            this {memory, DefaultLinksSizeStep}
        {
        }

        UnitedMemoryLinks(TMemory memory, std::int64_t memoryReservationStep) :
            this {memory, memoryReservationStep, LinksConstants<TLinkAddress>{}}
        {
        }

        UnitedMemoryLinks(TMemory memory, std::int64_t memoryReservationStep, LinksConstants<TLinkAddress> Constants) :
        ...
        void
        Init(TMemory& memory, std::size_t memoryReservationStep)
        {
