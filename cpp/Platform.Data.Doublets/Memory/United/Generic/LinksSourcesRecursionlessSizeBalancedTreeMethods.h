...
{
    public unsafe class LinksSourcesRecursionlessSizeBalancedTreeMethods<TLink> : public LinksRecursionlessSizeBalancedTreeMethodsBase<TLink>
    {
        public: LinksSourcesRecursionlessSizeBalancedTreeMethods(LinksConstants<TLink> constants, std::uint8_t* storage, std::uint8_t* header) : base(constants, storage, header) { }
