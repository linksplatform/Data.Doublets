namespace Platform::Data::Doublets::Memory::United::Generic
{
    ...
    {
        public: LinksSourcesRecursionlessSizeBalancedTreeMethods(LinksConstants<TLink> constants, std::uint8_t* links, std::uint8_t* header) : base(constants, links, header) { }
