namespace Platform::Data::Doublets::Memory::United::Generic
{
    ...
    public:
        ...
        UnitedMemoryLinksBase(TMemory memory, std::int64_t memoryReservationStep, LinksConstants<TLinkAddress> constants) : UnitedMemoryLinksBase{memory, memoryReservationStep, constants, IndexTreeType::Default}
        {
        }
