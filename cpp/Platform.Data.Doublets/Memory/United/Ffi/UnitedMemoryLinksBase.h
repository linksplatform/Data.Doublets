...
//void setup_shared_logger(SharedLogger logger);
    ...
    class UnitedMemoryLinksBase : public ILinks<TSelf, TLinkAddress>, public Interfaces::Polymorph<TSelf, TBase...>
    {
    private:
        void* _ptr;
    public:
...
//        using base::Create;
        ...
        UnitedMemoryLinksBase(std::string path) : _ptr {ByteUnitedMemoryLinks_New(path.c_str()) }, Constants {true }
        {
        }
