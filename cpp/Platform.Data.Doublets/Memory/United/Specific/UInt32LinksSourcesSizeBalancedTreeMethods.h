namespace Platform::Data::Doublets::Memory::United::Specific
{
    ...
    {
        public: UInt32LinksSourcesSizeBalancedTreeMethods(LinksConstants<std::uint32_t> constants, RawLink<std::uint32_t>* links, LinksHeader<std::uint32_t>* header) : base(constants, links, header) { }
