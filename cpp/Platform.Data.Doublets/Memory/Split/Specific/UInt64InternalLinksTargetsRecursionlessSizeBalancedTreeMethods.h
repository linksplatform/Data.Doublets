...
namespace Platform::Data::Doublets::Memory::Split::Specific
{
    public unsafe class UInt64InternalLinksTargetsRecursionlessSizeBalancedTreeMethods : public UInt64InternalLinksRecursionlessSizeBalancedTreeMethodsBase
    {
        ...
        public: ref std::uint64_t GetLeftReference(std::uint64_t node) override { return ref LinksIndexParts[node].LeftAsTarget; }

        public: ref std::uint64_t GetRightReference(std::uint64_t node) override { return ref LinksIndexParts[node].RightAsTarget; }
