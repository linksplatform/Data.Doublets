...
{
    public unsafe class ExternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink> : public RecursionlessSizeBalancedTreeMethods<TLink>, ILinksTreeMethods<TLink>
    {
        ...
        protected: ExternalLinksRecursionlessSizeBalancedTreeMethodsBase(LinksConstants<TLink> constants, std::uint8_t* linksDataParts, std::uint8_t* linksIndexParts, std::uint8_t* header)
        {
