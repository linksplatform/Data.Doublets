namespace Platform::Data::Doublets::Memory::Split::Generic
{
    ...
    public:
        ...
        public: ExternalLinksSourcesSizeBalancedTreeMethods(std::uint8_t* linksDataParts, std::uint8_t* linksIndexParts, std::uint8_t* header) : base(constants, linksDataParts, linksIndexParts, header) { }
