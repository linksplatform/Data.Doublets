...
{
    public unsafe class ExternalLinksTargetsSizeBalancedTreeMethods<TLink> : public ExternalLinksSizeBalancedTreeMethodsBase<TLink>
    {
        public: ExternalLinksTargetsSizeBalancedTreeMethods(LinksConstants<TLink> constants, std::uint8_t* linksDataParts, std::uint8_t* linksIndexParts, std::uint8_t* header) : base(constants, linksDataParts, linksIndexParts, header) { }
