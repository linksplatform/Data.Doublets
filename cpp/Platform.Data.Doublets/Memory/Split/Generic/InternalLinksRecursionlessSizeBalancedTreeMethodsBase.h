...
{
    public unsafe class InternalLinksRecursionlessSizeBalancedTreeMethodsBase<TLink> : public RecursionlessSizeBalancedTreeMethods<TLink>, ILinksTreeMethods<TLink>
    {
        ...
        protected: InternalLinksRecursionlessSizeBalancedTreeMethodsBase(LinksConstants<TLink> constants, std::uint8_t* linksDataParts, std::uint8_t* linksIndexParts, std::uint8_t* header)
        {
