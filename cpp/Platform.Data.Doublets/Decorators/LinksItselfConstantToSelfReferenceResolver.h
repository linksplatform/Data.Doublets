namespace Platform::Data::Doublets::Decorators
{
    ...
    template <typename TLink> class LinksItselfConstantToSelfReferenceResolver<TLink> : public DecoratorBase<TFacade, TDecorated>
    {
        ...
        public: TLink Update(const  LinkType& restriction, CArray<TLinkAddress> auto&& substitution) override { return this->decorated().Update(restriction, this->decorated().ResolveConstantAsSelfReference(_constants.Itself, restriction, substitution)); }
    };
}
